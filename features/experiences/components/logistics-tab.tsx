...
import type { LogisticsCategory, LogisticsCategoryGroup, LogisticsStatus } from "@/features/experiences/data";
...
export function LogisticsTab({ experienceSlug, isLocked, groups }: Props) {
    ...
    <div className="space-y-6">
      ...
      {isLocked && (
        <p className="text-sm text-muted-foreground">
          This experience is no longer active, so the logistics checklist is read-only.
        </p>
      )}
