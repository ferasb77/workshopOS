...
import type { ClientDetailRecord } from "@/features/clients/data";

import { updateClient, type UpdateClientResult } from "../actions";
import { CLIENT_TYPE_LABELS, CLIENT_TYPES, COUNTRIES } from "../schema";

const initialState: UpdateClientResult = { success: false, error: "", values: {} };
...
export function ClientEditForm({ client }: Props) {
  ...
  const [state, action] = useActionState(boundUpdateClient, initialState);
      ...
      <Card className="bg-surface-elevated">
        ...
        <CardContent className="grid gap-5 sm:grid-cols-2">
          <div className="space-y-2 sm:col-span-2">
            ...
            <Input id="name" name="name" required defaultValue={field("name", client.name)} />
          ...
          <div className="space-y-2">
            ...
            <Select
              name="type"
              defaultValue={field("type", client.type)}
          ...
          <div className="space-y-2">
            ...
            <Input id="industry" name="industry" defaultValue={field("industry", client.industry ?? "")} />
          </div>

          <div className="space-y-2">
            <Label htmlFor="country">Country</Label>
            <Select name="country" defaultValue={field("country", client.country ?? "") || undefined}>
          ...
          <div className="space-y-2">
            ...
            <Input id="city" name="city" defaultValue={field("city", client.city ?? "")} />
          </div>
          ...
          <div className="space-y-2 sm:col-span-2">
            ...
            <Input
              ...
              type="url"
              placeholder="https://"
              defaultValue={field("website", client.website ?? "")}
            />
        ...
        <CardContent className="grid gap-5 sm:grid-cols-2">
          <div className="space-y-2">
            ...
            <Input
              ...
              defaultValue={field("primaryContactName", client.primaryContactName ?? "")}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              type="email"
              defaultValue={field("primaryContactEmail", client.primaryContactEmail ?? "")}
            />
          ...
          <div className="space-y-2 sm:col-span-2">
            ...
            <Input
              ...
              type="tel"
              defaultValue={field("primaryContactPhone", client.primaryContactPhone ?? "")}
            />
          </div>

          <div className="space-y-2 sm:col-span-2">
            <Label htmlFor="notes">Notes</Label>
            <Textarea id="notes" name="notes" rows={3} defaultValue={field("notes", client.notes ?? "")} />
          </div>
        </CardContent>
      </Card>
